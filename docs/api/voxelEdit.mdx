...
### nil ReplaceVoxelDataResourceMaterial(VoxelDataResource, string, string, boolean) {#nil-ReplaceVoxelDataResourceMaterial-VoxelDataResource-string-string-boolean}
