...
### nil FixedUpdate() {#nil-FixedUpdate}

### nil Update(number deltaTime) {#nil-Update-number-deltaTime}
Called once a frame after Start() if the object is active 

### nil LateUpdate(number deltaTime) {#nil-LateUpdate-number-deltaTime}
...
### nil EditorAttach() {#nil-EditorAttach}

### nil EditorDetach() {#nil-EditorDetach}

### nil EditorStart() {#nil-EditorStart}

### nil EditorFixedUpdate() {#nil-EditorFixedUpdate}

### nil EditorUpdate(number deltaTime) {#nil-EditorUpdate-number-deltaTime}

### nil EditorLateUpdate(number deltaTime) {#nil-EditorLateUpdate-number-deltaTime}

### nil EditorOnActivate() {#nil-EditorOnActivate}

### nil EditorOnDeactivate() {#nil-EditorOnDeactivate}

### nil RPC(string funcName, ... args) {#nil-RPC-string-funcName-args}
