...
who can move the object and not receive the rendered position from the server via [`VoxelData.receiveTransform = false`](docs\api\voxelRenderer.mdx#boolean-receiveTransform)
